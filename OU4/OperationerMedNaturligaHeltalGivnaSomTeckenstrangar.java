...
class OperationerMedNaturligaHeltalGivnaSomTeckenstrangar
{
	 ...
	 {
		//Omvandlar strängarna till int, adderar de och sparar sedan de i en ny int variabel
	 	int sum = Integer.parseInt(tal1) + Integer.parseInt(tal2);

		//omvandlar sum till en sträng och retunerar den
	 ...
	 public static String subtrahera (String tal1, String tal2)
	 {
		...
		int diff = Integer.parseInt(tal1) - Integer.parseInt(tal2);
